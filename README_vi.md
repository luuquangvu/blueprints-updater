...
- **Quy trình phát triển chặt chẽ**:
  ...
  - **[Ty](https://github.com/astral-sh/ty)** & **[Pyright](https://github.com/Microsoft/pyright)**: Kiểm tra kiểu dữ liệu (**cấu hình tiêu chuẩn**) để tăng độ ổn định cho lõi hệ thống.
