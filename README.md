...
- **Rigorous Development Workflow**:
  ...
  - **[Ty](https://github.com/astral-sh/ty)** & **[Pyright](https://github.com/Microsoft/pyright)**: Type checking (**configured as standard**) to help prevent runtime errors and enhance stability.
